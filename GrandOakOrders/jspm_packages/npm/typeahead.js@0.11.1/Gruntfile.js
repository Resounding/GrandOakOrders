...
var semver = require("semver"),
    ...
    files = {
      ...
      typeahead: ['src/typeahead/www.js', 'src/typeahead/event_bus.js', 'src/typeahead/event_emitter.js', 'src/typeahead/highlight.js', 'src/typeahead/input.js', 'src/typeahead/dataset.js', 'src/typeahead/menu.js', 'src/typeahead/default_menu.js', 'src/typeahead/typeahead.js', 'src/typeahead/plugin.js']
    };
module.exports = function(grunt) {
  grunt.initConfig({
    ...
    uglify: {
      ...
      bundle: {
        ...
        src: ['<%= tempDir %>/bloodhound.js', '<%= tempDir %>/typeahead.jquery.js'],
    ...
    exec: {
      ...
      git_commit: {cmd: function(m) {
          return f('git commit -m "%s"', m);
        }},
      git_tag: {cmd: function(v) {
  ...
  grunt.registerTask('manifests', 'Update manifests.', function(version) {
    ...
    pkg = JSON.stringify(_.extend(pkg, {version: version}), null, 2);
  ...
  grunt.registerTask('build', ['uglify:concatBloodhound', 'uglify:concatTypeahead', 'umd:bloodhound', 'umd:typeahead', 'uglify:bloodhound', 'uglify:bloodhoundMin', 'uglify:typeahead', 'uglify:typeaheadMin', 'uglify:bundle', 'uglify:bundleMin', 'sed:version']);
