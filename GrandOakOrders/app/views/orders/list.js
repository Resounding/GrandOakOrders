System.register(['aurelia-framework', 'aurelia-fetch-client', 'aurelia-router', '../../models/order'], function(exports_1, context_1) {
    "use strict";
    ...
    var aurelia_framework_1, aurelia_fetch_client_1, aurelia_router_1, order_1;
    var OrdersList;
    return {
        setters:[
                    ...
                    this.httpClient.fetch("/api/orders" + queryString)
                        ...
                        res.json().then(function (content) {
                            _this.orders = _.chain(content)
                                ...
                                .value();
                            _.each(_this.orders, function (order) {
                                order.hasOrderingNotes = _.any(order.Items, function (item) { return item.OrderingNotes; });
                            });
                        });
                    }, function (err) {
                        console.log(err);
