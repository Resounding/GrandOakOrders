...
System.register(['aurelia-framework', 'aurelia-fetch-client', 'aurelia-router', '../../models/emailDelivery', '../../models/order', '../../models/email', '../../models/itemTemplate'], function(exports_1, context_1) {
    "use strict";
    ...
    var aurelia_framework_1, aurelia_fetch_client_1, aurelia_router_1, emailDelivery_1, order_1, email_1, itemTemplate_1;
    var EditOrder;
    return {
        setters:[
        ...
        execute: function() {
            EditOrder = (function () {
                ...
                EditOrder.prototype.sortItems = function () {
                    this.sortedItems = _.sortBy(this._model.Items, function (item) { return item.SortOrder; });
                };
                ...
                EditOrder.prototype.allInPricing = function () {
                    var _this = this;
                    var itemsOnInvoice = _.filter(this._model.Items, function (item) { return item.ShowOnInvoice; });
                    ...
                    this.submit()
                        ...
                        $modal.openModal({
                            ready: function () {
                                ...
                                $modal.off().on('click', 'button.blue', _.bind(function (e) {
                                    e.preventDefault();
